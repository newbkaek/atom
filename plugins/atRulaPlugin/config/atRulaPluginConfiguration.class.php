...
class atRulaPluginConfiguration extends sfPluginConfiguration
{
  public static
    $summary = 'Theme plugin forked from the arDominionPlugin.',
    $version = '0.0.1';
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/atRulaPlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/atRulaPlugin/css/main.css', 'last', array('media' => 'all'));
    }
  }
